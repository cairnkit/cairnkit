...
- c13b012: Match `pauseRoutes`, `handoffRoutes` and `resumeAt` against route patterns, not just exact pathnames.
...
- 264bf96: Flag `anchor_missing` when the step that raised it was `optional`.
