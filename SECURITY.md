...
cairnkit renders inside a host application, reads its DOM, and can emit analytics.
...
**Copy rendering.** Step titles and bodies are rendered as text. cairnkit never
...
cairnkit needs no `unsafe-eval` and no remote origins. Styles ship as a static
